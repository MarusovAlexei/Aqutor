const sliderImages = [
  {
    ...
    address:
      "107045, Российская Федерация, Московская область, г. Москва, Большая Сухаревская площадь 14/7, магазин «Ионизаторы воды»",
  ...
  },
  {
    ...
    address:
      "443010, Российская Федерация,  Самарская область, г. Самара, улица Льва Толстого 67, магазин «Ионизаторы воды»",
...
document.querySelectorAll(".dropdown-container").forEach(function (container) {
  ...
  const span = document.querySelectorAll(".dropdown-arrow");
  console.log(span);
  header.addEventListener("click", function () {
    span.classList.toggle("dropdown-arrow-open");
